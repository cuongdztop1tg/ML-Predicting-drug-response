...
from . import csa_bruteforce_params_def
...
# Make output_dir
output_dir = Path(params['csa_outdir'])
if output_dir.exists() is False:
    os.makedirs(output_dir, exist_ok=True)

#Model scripts
model_name = params["model_name"]
preprocess_python_script = f'LGBM/{model_name}_preprocess_improve.py'
train_python_script = f'LGBM/{model_name}_train_improve.py'
infer_python_script = f'LGBM/{model_name}_infer_improve.py'
